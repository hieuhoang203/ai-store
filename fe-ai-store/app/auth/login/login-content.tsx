    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-4">
        <div className="space-y-4 text-center">
          ...
          <p className="text-sm font-semibold text-zinc-300">Đang xác thực đăng nhập...</p>
        </div>
      </main>
    );
  }
      ...
      <div className="w-full max-w-sm text-center">
        <div className="rounded-2xl border border-red-400/20 bg-red-400/10 p-6 shadow-xl">
          ...
          <p className="mt-4 text-xs text-zinc-500">
            Vui lòng gõ{" "}
            <code className="text-emerald-300">/admin</code> lại trong Telegram để lấy
            link mới (link chỉ dùng được 1 lần, trong 5 phút).
          </p>
        </div>
      </div>
    </main>
